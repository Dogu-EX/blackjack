sandalye_one = createObject(2350,1963.97265625, 1020.107421875, 991.85)
setElementInterior(sandalye_one,10)
setElementDimension(sandalye_one,162)
setElementRotation(sandalye_one, 0, 0, 530.77798461914)
...
exports["athenadev_infobox"]:addBox("info", "Daha Fazla Kart Çekemezsin.")
else
exports["athenadev_infobox"]:addBox("success", "Bir Kart Çektin.")
...
exports["athenadev_infobox"]:addBox("warning", "Lütfen bir bahis miktarı seçin!")
return 
end
if exports.athenadev_global:hasMoney(localPlayer,panel.bahis_miktari) then 
else
exports["athenadev_infobox"]:addBox("warning", "Seçtiğiniz Bahis miktari kadar paranız bulunmamakta!")
return 
end
...
exports["athenadev_infobox"]:addBox("success", "$"..panel.bahis_miktari.." bahis yatırdın.")
exports["athenadev_infobox"]:addBox("info", "Kartlar Dağıtılıyor...")
...
exports["athenadev_infobox"]:addBox("warning", "Kurpiyer Kartları Açıyor!")
...
exports["athenadev_infobox"]:addBox("info", "Berabere (Kurpiyer: "..panel.kurpiyer.." Sen: "..panel.sen..")")
exports["athenadev_infobox"]:addBox("success", "$"..panel.bahis_miktari.." bahisini geri aldın.")
elseif panel.sen > 21 and panel.kurpiyer < 21 then
exports["athenadev_infobox"]:addBox("info", "Kaybettin! (Kurpiyer: "..panel.kurpiyer.." Sen: "..panel.sen..")")
...
exports["athenadev_infobox"]:addBox("info", "Kurpiyer Battı! (Kurpiyer: "..panel.kurpiyer.." Sen: "..panel.sen..")")
elseif panel.sen >= panel.kurpiyer then
eklenecek=panel.bahis_miktari*2
exports["athenadev_infobox"]:addBox("info", "Kazandın! (Kurpiyer: "..panel.kurpiyer.." Sen: "..panel.sen..")")
triggerServerEvent("c_para_kes",getLocalPlayer(),getLocalPlayer(),"ekle",eklenecek)
end
end,3000,1)
setTimer(function()
